                  ...
                  <div key={i} style={{ 
                    ...
                    <div>
                      <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center', marginBottom: '0.25rem' }}>
                         ...
                         <span style={{ fontWeight: 600 }}>{lead.location}</span>
                      </div>
      ...
      <section className="section" style={{ padding: '8rem 5%', background: '#FFFFFF' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: 800, marginBottom: '1.5rem' }}>Why Permit Data?</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem' }}>
             {[
               ...
               <div key={i} style={{ padding: '2rem', borderRadius: '24px', background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
