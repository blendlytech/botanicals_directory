    ...
    <main className="miami-landing" style={{ background: '#040806', color: '#FFFFFF', minHeight: '100vh' }}>
      ...
      <div className="festival-banner">
        <div className="banner-content">
          ...
          <span className="banner-text">RARE PLANT & ORCHID FESTIVAL • MIAMI • MAY 2026</span>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '6rem 5% 4rem', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
          ...
          <p style={{ fontSize: '1.25rem', color: 'var(--text-secondary)', maxWidth: '800px', margin: '0 auto 3rem', lineHeight: 1.6 }}>
            The Rare Plant & Orchid Festival in Miami is the ultimate proving ground. 
        ...
        <section id="apply" style={{ marginTop: '8rem' }}>
          ...
          <div className="pricing-grid">
            ...
            <div className="pricing-card featured">
              <div className="featured-tag">MOST POPULAR FOR MIAMI</div>
              <div className="card-header">
                <h3>Bloom</h3>
            ...
            <div className="pricing-card">
              ...
              <Link href="/signup?tier=elite&promo=miami" className="btn-ghost" style={{ width: '100%', textAlign: 'center' }}>Claim Lifetime Seat</Link>
            </div>
          </div>
        </section>
